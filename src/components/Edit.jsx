                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Form.Group>
                    ...
                    <Form.Control
                      ...
                      type="text"
                      defaultValue={Pozo.metrosPerforado}
                      ref={register({ required: true })}
                    />
                    <Form.Text className="text-muted">
                      {errors.metrosPerforado && (
                        <Alert variant="danger">Este campo es requerido</Alert>
                      )}
                    </Form.Text>
                  </Form.Group>
                  <Form.Group>
                    ...
                    <Form.Control
                      ...
                      type="date"
                      defaultValue={Pozo.inicioPerforacion}
                      ref={register({ required: true })}
                    />
                    <Form.Text className="text-muted">
                      {errors.inicioPerforacion && (
                        <Alert variant="danger">Este campo es requerido</Alert>
                      )}
                    </Form.Text>
                  </Form.Group>
                  ...
                  <Form.Group>
                    ...
                    <Form.Control
                      name="finPerforacion"
                      defaultValue={Pozo.finPerforacion}
                      type="date"
                      ref={register()}
                    />
                    <Form.Text className="text-muted">
                      {errors.finPerforacion && (
                        <Alert variant="danger">Este campo es requerido</Alert>
                      )}
                    </Form.Text>
                  </Form.Group>
                  ...
                  <Form.Group>
                    ...
                    <Form.Control
                      as="select"
                      ref={register()}
                      defaultValue={Pozo.EquipoPerforacion}
                      name="EquipoPerforacion"
                    >
                  ...
                  <Form.Group>
                    ...
                    <Form.Control
                      name="fechaEntregado"
                      defaultValue={Pozo.fechaEntregado}
                      type="date"
                      ref={register()}
                    />
                    <Form.Text className="text-muted">
                      {errors.fechaEntregado && (
                        <Alert variant="danger">Este campo es requerido</Alert>
                      )}
                    </Form.Text>
                  </Form.Group>
